  ...
  >
    ...
    >
      ...
      <div className="flex w-full flex-row items-center justify-between">
        <h1 className="flex-1 font-poppins font-semibold leading-[75px] text-[52] text-white ss:text-[72px] ss:leading-[100px]">
      ...
      <h1 className="font-poppins font-semibold leading-[75px] text-[52] text-white ss:text-[68px] ss:leading-[100px]">
        Payment Method
      </h1>
    ...
    {/* Robot Image */}
    <div className={`relative my-10 flex flex-1 ${styles.flexCenter} md:my-0`}>
      <img
        src={robot}
        alt="billing"
